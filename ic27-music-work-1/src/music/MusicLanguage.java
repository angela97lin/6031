...
public class MusicLanguage {
    ...
    //
    // TODO transpose : Music x and an integer to transpose by -> new Music transposed
    //
    
    public static Music transpose(Music m, int semitones){
        //return m.transpose(semitones);
        return new Transpose(m, semitones);
    }

    // TODO repeat : Music x int times to repeat -> Music
    public static Music repeat(Music m, int repeat) {
        // if base case //repeat = 1
        return m;
        // else recursive case concat onto m and decrease repeat and call repeat on that
        // return ???
    }
}
