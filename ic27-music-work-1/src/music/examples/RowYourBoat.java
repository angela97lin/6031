...
public class RowYourBoat {
    ...
    public static void main(String[] args) throws MidiUnavailableException, InvalidMidiDataException {
        ...
        MusicPlayer.play(concat(rowYourBoat,
                                transpose(rowYourBoat, 12)));
        //MusicPlayer.play(rowYourBoat).transpose(12);
        //MusicPlayer.play(rowYourBoat).transpose(-12);//we can transpose pitches, but how to transpose notes?
        //MusicPlayer.play(rowYourBoat).transpose(5);
